...
public class KafkaConsumerCfg {
    ...
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, CanonicalTrade>> listenerFactory(
            ConsumerFactory<String, CanonicalTrade> consumerFactory
    ) {
        ConcurrentKafkaListenerContainerFactory<String, CanonicalTrade> factory = new ConcurrentKafkaListenerContainerFactory<>();
